...
export default function AntimicrobialPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <TopBar title="Antimicrobial Stewardship" subtitle="Antibiotic usage monitoring" />
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <KpiCard label="Total Records" value={dashboard.total || records.length || 0} icon={Pill} color="#0F766E" />
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              ...
              : records.length === 0 ? <tr><td colSpan={4}><EmptyState icon={<Pill size={36} />} title="No records yet" description="Records will appear here when created" /></td></tr>
              : records.map((r: any) => (
