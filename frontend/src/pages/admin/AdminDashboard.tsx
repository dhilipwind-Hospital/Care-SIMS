...
export default function AdminDashboard() {
  ...
  const modules = [
    { title: 'Patients', link: '/app/admin/patients', desc: 'Register & manage patients', Icon: Users, color: '#0F766E' },
    { title: 'Users & Staff', link: '/app/admin/users', desc: 'Manage staff accounts and roles', Icon: Shield, color: '#3B82F6' },
    { title: 'Appointments', link: '/app/admin/appointments', desc: 'OPD appointment scheduling', Icon: CalendarCheck, color: '#8B5CF6' },
    ...
    { title: 'Inventory', link: '/app/admin/inventory', desc: 'Stock levels & expiry alerts', Icon: Package, color: '#EF4444' },
    { title: 'Billing', link: '/app/admin/billing', desc: 'Invoices and collections', Icon: DollarSign, color: '#06B6D4' },
    { title: 'Pharmacy', link: '/app/admin/pharmacy', desc: 'Prescriptions & dispensing', Icon: Pill, color: '#EC4899' },
    { title: 'Lab', link: '/app/admin/lab', desc: 'Orders and results', Icon: FlaskConical, color: '#14B8A6' },
    { title: 'Admissions', link: '/app/admin/admissions', desc: 'IPD bed management', Icon: Bed, color: '#F97316' },
    { title: 'OT Management', link: '/app/admin/ot', desc: 'Theatre scheduling', Icon: Syringe, color: '#6366F1' },
    { title: 'Emergency', link: '/app/admin/emergency', desc: 'Emergency & triage', Icon: HeartPulse, color: '#DC2626' },
    ...
    { title: 'Duty Roster', link: '/app/admin/duty-roster', desc: 'Staff shifts & scheduling', Icon: ClipboardList, color: '#7C3AED' },
    { title: 'Vendors', link: '/app/admin/vendors', desc: 'Suppliers & contracts', Icon: Truck, color: '#92400E' },
    { title: 'Purchase Indents', link: '/app/admin/purchase-indents', desc: 'Procurement requests', Icon: Activity, color: '#065F46' },
