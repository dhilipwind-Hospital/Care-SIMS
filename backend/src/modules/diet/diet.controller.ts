...
export class DietController {
  ...
  @Post('orders')
  createOrder(@CurrentUser('tenantId') tid: string, @CurrentUser('locationId') lid: string, @CurrentUser('sub') uid: string, @Body() body: any) { return this.svc.createOrder(tid, { ...body, locationId: body.locationId || lid, doctorId: body.doctorId || uid }); }
