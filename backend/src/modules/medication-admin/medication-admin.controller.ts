...
export class MedicationAdminController {
  ...
  @Post('prn') schedulePrn(@CurrentUser('tenantId') tid: string, @CurrentUser('locationId') lid: string, @Body() body: any, @CurrentUser('sub') uid: string) { return this.svc.schedulePrnDose(tid, { ...body, locationId: body.locationId || lid }, uid); }
